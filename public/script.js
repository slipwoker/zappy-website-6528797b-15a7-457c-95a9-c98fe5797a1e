document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!action) {
        // No action defined – fire custom event and reset UI
  ...
  function initScrollAnimations() {
    const elements = document.querySelectorAll('[' + ANIMATION_ATTRIBUTE + ']');
    ...
    const mutationObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          ...
          if (node.hasAttribute && node.hasAttribute(ANIMATION_ATTRIBUTE)) {
            initScrollAnimations();
          }

          const nested = node.querySelectorAll && node.querySelectorAll('[' + ANIMATION_ATTRIBUTE + ']:not(.' + VISIBLE_CLASS + ')');
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6528797b-15a7-457c-95a9-c98fe5797a1e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6528797b-15a7-457c-95a9-c98fe5797a1e';
